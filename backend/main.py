...
from api.routes import users, students, events, event_registrations, projects, publications, alumni, collaborators
...
app.include_router(event_registrations.router, prefix="/api", tags=["event_registrations"])
