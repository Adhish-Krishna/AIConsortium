export const events = [
  {
    ...
    description: "Join leading experts to discuss the ethical implications of advanced AI systems and regulatory frameworks.",
  ...
  },
  {
    ...
    description: "Hands-on workshop covering the latest advancements in machine learning algorithms and practical applications.",
  ...
  },
  {
    ...
    description: "Explore cutting-edge research in neural networks and deep learning architectures with industry pioneers.",
...
export const discussions = [
  ...
  },
  {
    ...
    replies: 64,
    views: 1752,
    excerpt: "Developing comprehensive ethical guidelines for the deployment of autonomous AI systems in critical sectors."
  }
];
